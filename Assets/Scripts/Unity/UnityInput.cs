...
public class UnityInput : MonoBehaviour
{
    ...
    {
        Vector2 input = value.Get<Vector2>();   // vector2로 받아오고
    }

    private void OnJump(InputValue value)
    {
        bool isPress = value.isPressed;         // ispressed로 받아온다.
    }
