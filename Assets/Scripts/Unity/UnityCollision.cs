...
public class UnityCollision : MonoBehaviour
{
    ...
    {
        Debug.Log("OnCollisionEnter");      // 유니티의 충돌에 진입했을 때
    }

    private void OnCollisionStay(Collision collision)
    {
        Debug.Log("OnCollisionStay");       // 유니티에 계속 충돌되고 있을 때
    }

    private void OnCollisionExit(Collision collision)
    {
        Debug.Log("OnCollisionExit");       // 유니티에서 떨어졌을 때
    }
    ...
    // <레이어기반 충돌 감지>
    // 게임오브젝트의 레이어를 활용하여 충돌체간의 충돌가능 여부를 설정한다.
    // edit -> Projectsetting -> Physics 설정 가능
}
